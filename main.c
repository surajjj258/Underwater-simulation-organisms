...
void screen()
{
	...
	drawstring(350,325,0.0,"NIE INSTITUTE OF TECHNOLOGY MYSURU ",1);
		glColor3f(0.0,0.0,0.0);
	drawstring(310,385,0.0,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING",1);
		glColor3f(0.6,1.0,0.0);
	drawstring(450,350,0.0,"CG MINI PROJECT",1);
		glColor3f(1.0,1.0,0.0);
	drawstring(340,300,0.0,"SIMULATION OF UNDERWATER ORGANISMS",1);
	 	glColor3f(1.0,0.0,0.0);
	  drawstring(135,205,0.0," DONE BY",0);
	  	glColor3f(0.0,0.0,0.0);
	drawstring(140,170,0.0,"CHIRAG MN - 4NN21CS010",0);
	drawstring(140,135,0.0,"SURAJ S - 4NN21CS057",0);
		glColor3f(1.0,0.0,0.0);
	drawstring(710,205,0.0,"Under the Guidance of",0);
		glColor3f(0.0,0.0,0.0);
	drawstring(720,170,0.0,"Prof DEEPAK P",0);
		glColor3f(1.0,1.0,0.0);
